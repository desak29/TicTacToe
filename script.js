...
/* creates and restoring a game board, adding Xs and Os to the board, saving game state */
...
function checkForWinner() {
  ...
  if (!JSON.stringify(board).match(/,"",/)) {
    if (confirm("Tic Tac draw. Cat Scratch to the New game?")) {
      newGame();
    }
  }
}
...
// // parts of this function were taken from Apples tic tac toe model
